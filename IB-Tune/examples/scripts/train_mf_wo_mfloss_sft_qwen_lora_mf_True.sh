...
openrlhf.cli.train_mf \
   ...
   --save_path /mnt/nasdata/qirui/language_model/qwen2-1.5B-mf_wo_mfloss-0302-mf_model-950\
   --ckpt_path /mnt/nasdata/qirui/ckpt/mf_wo_mfloss/0302_mf_model/checkpoints_sft/
   --save_steps 10 \
   --train_data_n 400 \
   --logging_steps 1 \
   --eval_steps -1 \
