...
class DeepspeedStrategy(ABC):
    ...
    def setup_dataloader(
        ...
        return DataLoader(
            ...
            persistent_workers=persistent_workers,  # 新增
        )
    ...
    def save_model(self, model: nn.Module, tokenizer, output_dir, **kwargs) -> None:
        ...
        if self.is_rank_0():
            ...
            if getattr(model_to_save.config, "tie_word_embeddings", False) and "base_model.model.lm_head.weight" in state_dict_keys:
